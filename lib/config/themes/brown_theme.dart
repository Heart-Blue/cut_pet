...
final ThemeData brownTheme = ThemeData(
  primaryColor: AppColors.activeBrown, // 主题色
  scaffoldBackgroundColor: AppColors.page, // 脚手架下的页面背景色
  indicatorColor: AppColors.activeBrown, // 选项卡栏中所选选项卡指示器的颜色。
  // ElevatedButton 主题
  elevatedButtonTheme: ElevatedButtonThemeData(
    style: ButtonStyle(
      ...
      backgroundColor: MaterialStateProperty.resolveWith((states) {
        if (states.contains(MaterialState.disabled)) {
          return AppColors.activeBrown.withOpacity(0.5);
        } else {
          return AppColors.activeBrown;
        }
      }),
    ),
  ),
  ...
  appBarTheme: AppBarTheme(
      backgroundColor: AppColors.activeBrown,
      elevation: 0,
      centerTitle: true,
  ...
  bottomNavigationBarTheme: BottomNavigationBarThemeData(
    ...
    selectedItemColor: AppColors.activeBrown,
