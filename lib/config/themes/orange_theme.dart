...
final ThemeData orangeTheme = ThemeData(
  primaryColor: AppColors.activeOrange, // 主题色
  scaffoldBackgroundColor: AppColors.page, // 脚手架下的页面背景色
  indicatorColor: AppColors.activeOrange, // 选项卡栏中所选选项卡指示器的颜色。
  // ElevatedButton 主题
  elevatedButtonTheme: ElevatedButtonThemeData(
    style: ButtonStyle(
      ...
      backgroundColor: MaterialStateProperty.resolveWith((states) {
        if (states.contains(MaterialState.disabled)) {
          return AppColors.activeOrange.withOpacity(0.5);
        } else {
  ...
  bottomNavigationBarTheme: BottomNavigationBarThemeData(
    ...
    selectedItemColor: AppColors.activeOrange,
