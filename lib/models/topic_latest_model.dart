class TopicLatestItemModel {
  ...
  TopicLatestItemModel.fromJson(Map<String, dynamic> json) {
...
class TopicLatestListModel {
  List<TopicLatestItemModel> list;
  TopicLatestListModel({required this.list});

  factory TopicLatestListModel.fromJson(List list) {
    return TopicLatestListModel(list: list.map((e) => TopicLatestItemModel.fromJson(e)).toList());
  }
}
